...
Here are some code examples that run identically on Python 3 and 2::
    ...
    >>> from past import str as oldstr
    ...
    >>> from past import execfile
    >>> execfile('myfile.py')

    >>> from past import raw_input
    >>> name = raw_input('What is your name? ')
    What is your name? [cursor]

    >>> from past import reload
    >>> reload(mymodule)   # equivalent to imp.reload(mymodule) in Python 3

    >>> from past import xrange
    >>> for i in xrange(10):
    ...     pass
