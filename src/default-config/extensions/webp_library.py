...
class WebPSaver(LibrarySaver):
    register_library_name: str = "Save as WebP"
    register_library_id: str = "webp_lib"
...
class WebPLibraryProvider(LibraryProvider):
    register_provider_name: str = "WebP Lib"
    register_provider_id: str = "webp_lib"
    register_saver: _ty.Type[CoreSaver] | None = WebPSaver
